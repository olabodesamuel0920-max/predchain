...
ALTER TABLE public.wallet_transactions 
  ...
  ADD CONSTRAINT wallet_transactions_type_check CHECK (type IN ('deposit', 'entry_fee', 'reward', 'referral_credit', 'withdrawal', 'reversal', 'refund', 'purchase', 'admin_adjustment')),
