...
import { initializeRoundEntry } from '@/app/actions/challenges';
...
export default function LiveChallengesClient({ 
  round, 
  matches, 
  userEntry, 
  predictions,
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row md:items-center gap-24 md:gap-48 p-20 bg-white/[0.02] rounded-2xl border border-white/5 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-12 shrink-0">
               ...
               <div className="font-display text-xs font-black text-muted uppercase tracking-widest">Streak Progress</div>
            </div>
        ...
        <div className="container max-w-900">
          ...
          {!userEntry && (
            <div className="card text-center p-48 md:p-80 mb-64 border-dashed border-blue-electric/20 bg-blue-electric/[0.02] animate-slide-up">
              ...
              <h3 className="font-display text-2xl font-black text-white mb-16 uppercase tracking-tight">Challenge Participation Matrix</h3>
              
              {hasTier ? (
                <>
                  <p className="text-sm font-medium text-muted mb-32 max-w-400 mx-auto leading-relaxed">
                    Account tier verified. Initialize your challenge node to begin the reward sequence for Round {roundNumber}.
                  </p>
                  <button 
                    disabled={isPending || !round}
                    onClick={handleEnterRound}
                    className="btn btn-primary px-32 py-12 font-black uppercase text-xs tracking-widest shadow-xl shadow-gold/20 flex items-center gap-12 mx-auto w-fit group"
                  >
                    {isPending ? 'Initializing...' : 'ENTER CHALLENGE ROUND'} <Zap className="w-14 h-14" />
                  </button>
                </>
              ) : (
                <>
                  <p className="text-sm font-medium text-muted mb-32 max-w-400 mx-auto leading-relaxed">
                    System requires a verified account tier to initialize your reward sequence and access live challenge nodes.
                  </p>
