      ...
      <div className="container relative z-10 px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12 items-stretch">
          <div className="lg:col-span-8 card-elite !p-12 md:!p-16 bg-[#080a0f] border-gold/10 flex flex-col justify-center">
             <div className="badge-elite !text-gold mb-8 px-5 py-1 bg-white/[0.03]">ARENA PARTNERS</div>
             <h1 className="mb-6">Expand the <span className="text-gradient-gold">Arena.</span></h1>
             <p className="text-muted text-sm md:text-base font-medium opacity-60 max-w-lg">
                Invite fellow players to the PredChain challenge and earn ₦1,000 for every verified membership activation.
             </p>
          </div>
          ...
          <div className="lg:col-span-4 card-elite !p-12 bg-black border-white/5 flex flex-col items-center justify-center text-center shadow-2xl relative overflow-hidden">
             ...
             <div className="text-[10px] font-black text-muted uppercase tracking-[0.2em] mb-4 opacity-40 italic">Rewards Generated</div>
             <div className="text-4xl md:text-5xl font-black text-white italic tracking-tighter leading-none mb-4 font-display">
        ...
        {!user && (
          <div className="card-luxury-gold !p-16 text-center mb-16 border-gold/20 shadow-gold/5 relative overflow-hidden">
             <div className="absolute top-0 right-0 p-8 opacity-10"><Users className="w-32 h-32" /></div>
             <div className="relative z-10 max-w-2xl mx-auto">
                <h2 className="mb-6 uppercase italic font-black">Become a <span className="text-gradient-gold">Partner.</span></h2>
                <p className="text-text-secondary text-sm font-normal mb-10 leading-relaxed italic opacity-80">
                   Join the PredChain partner program and earn consistent rewards for every new player you bring into the arena. 
                   No limits, automated payouts, and real-time tracking.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                   <Link href="/signup" className="btn-luxury btn-gold !py-4 !px-12 !text-[10px] shadow-sm">START EARNING NOW</Link>
                   <Link href="/login" className="btn-luxury btn-outline !py-4 !px-12 !text-[10px]">PARTNER LOGIN</Link>
                </div>
             </div>
          </div>
        )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16 animate-slide-up">
             ...
             <div className="card-elite !p-10 bg-[#080a0f] border-white/5 flex flex-col justify-between shadow-xl">
                <div>
                   <div className="flex items-center gap-3 mb-10">
                      ...
                      <div className="flex flex-col">
                         <span className="text-[10px] font-black text-white uppercase tracking-widest italic">Personal Partner Link</span>
                ...
                <div className="flex items-center justify-between pt-6 border-t border-white/5">
                   <span className="text-[8px] font-bold text-muted uppercase tracking-widest opacity-30 italic">Real-time Tracking Active</span>
             ...
             <div className="grid grid-cols-2 gap-8">
                <div className="card-elite !p-10 bg-[#080a0f] border-white/5 flex flex-col items-center justify-center text-center shadow-xl group hover:border-white/10">
                   ...
                   <span className="text-[10px] font-bold text-muted uppercase tracking-widest opacity-40">Total Partners</span>
                </div>
        ...
        {/* History Table */}
        {user && (
          <div className="space-y-6 mb-24 animate-slide-up">
             <div className="flex items-center gap-3 px-2 opacity-40">
                <Activity className="w-5 h-5 text-blue-electric" />
                <h2 className="text-[10px] font-black uppercase tracking-[0.4em] text-white italic">Partner Log</h2>
                         ...
                         {referrals.length === 0 ? (
                           <tr>
                              <td colSpan={4} className="py-24 text-center">
                                 <p className="text-[10px] font-black text-muted uppercase tracking-widest opacity-20 italic">No partners found in your network.</p>
                              </td>
                           </tr>
                         ) : (
                           referrals.map((r, i) => (
                             <tr key={r.id} className="hover:bg-white/[0.01] transition-colors group">
                                <td className="px-10 py-6">
                                   <div className="flex items-center gap-4">
                                      ...
                                      <span className="text-[11px] font-black text-white uppercase tracking-tight italic group-hover:text-gold transition-colors">@{r.referred_user?.username || 'Player'}</span>
                                   </div>
                                </td>
                                <td className="px-10 py-6">
